...
replace git.gonit.codes/dealer/actshub/protocol => git.gonit.codes/dealer/actshub/protocol.git v0.0.0-20250530065256-d85f819ba676
...
require (
	...
	github.com/hkjojo/go-toolkits/apptools v1.0.5 // indirect
