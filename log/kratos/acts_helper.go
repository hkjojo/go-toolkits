...
func (h *ActsHelper) Debugw(module, source, msg string) {
	...
	h.log(log.LevelDebug, append(keyvals, module, source, msgkey(msg))...)
}

// Infow logs a message at info level.
func (h *ActsHelper) Infow(module, source, msg string) {
	var keyvals []interface{}
	h.log(log.LevelInfo, append(keyvals, module, source, msgkey(msg))...)
}

// Warnw logs a message at warnf level.
func (h *ActsHelper) Warnw(module, source, msg string) {
	var keyvals []interface{}
	h.log(log.LevelWarn, append(keyvals, module, source, msgkey(msg))...)
}

// Errorw logs a message at error level.
func (h *ActsHelper) Errorw(module, source, msg string) {
	var keyvals []interface{}
	h.log(log.LevelError, append(keyvals, module, source, msgkey(msg))...)
}

// Fatalw logs a message at fatal level.
func (h *ActsHelper) Fatalw(module, source, msg string) {
	var keyvals []interface{}
	h.log(log.LevelFatal, append(keyvals, module, source, msgkey(msg))...)
	os.Exit(1)
}
